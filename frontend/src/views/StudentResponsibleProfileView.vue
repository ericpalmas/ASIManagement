...
export default {
  ...
  methods: {
    ...
    generateFile() {
      ...
      if (
        this.userData[0].profile_responsible_name !== null &&
        this.userData[0].profile_responsible_surname !== null
      ) {
        doc.text(
          'Profile responsible: ' +
      ...
      if (
        this.userData[0].advisor_name !== null &&
        this.userData[0].advisor_surname !== null
      ) {
        doc.text(
          'Advisor: ' +
